...
INSERT INTO `categories` VALUES (1,'Shoes','Feet Apparel for both men and women',1),(2,'clothing','Athletic wear',1),(3,'Accessories','Fitness accessories and gear',1);
...
CREATE TABLE `product_discounts` (
  ...
  CONSTRAINT `product_discounts_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`idProducts`),
...
CREATE TABLE `product_variants` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`),
  CONSTRAINT `product_variants_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`idProducts`)
...
INSERT INTO `products` VALUES (1,'red shoe',1,685.00,10,'red shoe.png'),(2,'black shoe',1,685.00,5,'black shoe.png'),(3,'blue shoe',1,685.00,14,'blue shoe.png'),(4,'brown shoe',1,685.00,20,'brown shoe.png'),(5,'white shoe',1,685.00,4,'white shoe.png');
...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `reviews_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`idProducts`),
...
INSERT INTO `users` VALUES (1,'admin','admin@gmail.com','admin','admin Avenue','91919191','admin'),(2,'Herald','herald@gmail.com','herald','Yishun Avenue','83838383','user');
...
-- Dump completed on 2025-07-24 10:30:48
